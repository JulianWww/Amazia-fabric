...
public class EconomyFactory {
	...
	public final static BaseItemEconomy COAL = 					register(Items.COAL, 					0.0666f, 	0.0001f, 	0.01f,	new ConstrainedGaussianIntRandom(20f, 8f, 64, 1), 	ImmutableSet.of("armorer", "butcher", "fischerman", "toolsmith", "weaponsmith"));
	...
	public final static BaseItemEconomy IRON_INGOT = 			register(Items.IRON_INGOT, 				0.25f,		0.001f, 	0.01f, 	new LinearRandom(1, 64), 						ImmutableSet.of("armorer", "toolsmith", "weaponsmith"));
	public final static BaseItemEconomy BELL = 					register(Items.BELL, 					36, 		2f, 		0.001f, new ConstantValue<Integer>(1), 					ImmutableSet.of("armorer", "toolsmith", "weaponsmith"));
	...
	public final static BaseItemEconomy DIAMOND = 				register(Items.DIAMOND, 				10,			0.01f, 		0.001f, new ConstrainedGaussianIntRandom(16f, 4f, 32, 1), 	ImmutableSet.of("armorer", "toolsmith", "weaponsmith"));
	...
	public final static BaseItemEconomy CHICKEN = 				register(Items.CHICKEN, 				0.07f, 		1f,			0.001f, new ConstrainedGaussianIntRandom(32, 16, 64, 1),	ImmutableSet.of("butcher"));
	public final static BaseItemEconomy PORKCHOP = 				register(Items.PORKCHOP, 				0.14f, 		1f,			0.001f, new ConstrainedGaussianIntRandom(32, 16, 64, 1),	ImmutableSet.of("butcher"));
	public final static BaseItemEconomy RABBIT = 				register(Items.RABBIT, 					0.25f, 		1f,			0.001f, new ConstrainedGaussianIntRandom(32, 16, 64, 1),	ImmutableSet.of("butcher"));
	...
	public final static BaseItemEconomy COOKED_PORKCHOP = 		ItemCompundEconomy.register(Items.COOKED_PORKCHOP, ImmutableSet.of(ImmutablePair.of(COAL, 0.2f), ImmutablePair.of(PORKCHOP, 1f)), new ConstrainedGaussianIntRandom(32, 16, 64, 1), ImmutableSet.of("butcher"));
	public final static BaseItemEconomy COOKED_CHICKEN = 		ItemCompundEconomy.register(Items.COOKED_CHICKEN,  ImmutableSet.of(ImmutablePair.of(COAL, 0.2f), ImmutablePair.of(CHICKEN,  1f)), new ConstrainedGaussianIntRandom(32, 16, 64, 1), ImmutableSet.of("butcher"));
	public final static BaseItemEconomy MUTTON = 				register(Items.MUTTON, 					0.14f, 		1f,			0.001f, new ConstrainedGaussianIntRandom(32, 16, 64, 1),	ImmutableSet.of("butcher"));
	public final static BaseItemEconomy BEEF = 					register(Items.BEEF, 					0.1f, 		1f,			0.001f, new ConstrainedGaussianIntRandom(32, 16, 64, 1),	ImmutableSet.of("butcher"));
	public final static BaseItemEconomy DRIED_KELP_BLOCK = 		register(Items.DRIED_KELP_BLOCK, 		0.1f, 		1f,			0.001f, new ConstrainedGaussianIntRandom(32, 16, 64, 1),	ImmutableSet.of("butcher"));
	public final static BaseItemEconomy SWEET_BERRIES = 		register(Items.SWEET_BERRIES, 			0.1f, 		1f,			0.001f, new ConstrainedGaussianIntRandom(32, 16, 64, 1),	ImmutableSet.of("butcher"));
	...
	public final static BaseItemEconomy GLASS_PANE =			register(Items.GLASS_PANE,		 		11f, 		1f,			0.001f, new ConstrainedGaussianIntRandom(48, 8, 64, 1),	ImmutableSet.of("cartographer"));
	...
	public final static BaseItemEconomy BANNER = 				register(Items.BLACK_BANNER,			13f, 		1f,			0.001f, new ConstrainedGaussianIntRandom(8, 4, 16, 1),		ImmutableSet.of("cartographer", "shepherd")).modify(BANNER_COLOR_MODIFIER);
	...
	public final static BaseItemEconomy GOLD_INGOT =			register(Items.GOLD_INGOT,				0.3f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(32, 8, 64, 1),	ImmutableSet.of("cleric"));
	public final static BaseItemEconomy LAPIS_LAZULI =			register(Items.LAPIS_LAZULI,			1f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(32, 8, 64, 1),	ImmutableSet.of("cleric"));
	public final static BaseItemEconomy RABBIT_FOOT =			register(Items.RABBIT_FOOT,				0.5f, 		0.1f,		0.001f, new ConstrainedGaussianIntRandom(32, 8, 64, 1),	ImmutableSet.of("cleric"));
	public final static BaseItemEconomy GLOWSTONE =				register(Items.GLOWSTONE,				4f, 		0.1f,		0.001f, new ConstrainedGaussianIntRandom(32, 8, 64, 1),	ImmutableSet.of("cleric"));
	public final static BaseItemEconomy SCUTE =					register(Items.SCUTE,					4f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(32, 8, 64, 1),	ImmutableSet.of("cleric", "leatherworker"));
	public final static BaseItemEconomy GLASS_BOTTLE =			register(Items.GLASS_BOTTLE,			0.1f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(32, 8, 64, 1),	ImmutableSet.of("cleric"));
	public final static BaseItemEconomy ENDER_PEARL =			register(Items.ENDER_PEARL,				5f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(32, 8, 64, 1),	ImmutableSet.of("cleric"));
	public final static BaseItemEconomy NETHER_WART =			register(Items.NETHER_WART,				0.05f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(32, 8, 64, 1),	ImmutableSet.of("cleric"));
	public final static BaseItemEconomy EXPERIENCE_BOTTLE =		register(Items.EXPERIENCE_BOTTLE,		4f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(32, 8, 64, 1),	ImmutableSet.of("cleric"));
	
	public final static BaseItemEconomy WHEAT =					register(Items.WHEAT,					0.05f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(20, 8, 64, 1),	ImmutableSet.of("farmer"));
	public final static BaseItemEconomy POTATO =				register(Items.POTATO,					0.05f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(26, 8, 64, 1),	ImmutableSet.of("farmer"));
	public final static BaseItemEconomy CARROT =				register(Items.CARROT,					0.05f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(22, 8, 64, 1),	ImmutableSet.of("farmer"));
	public final static BaseItemEconomy BEETROOT =				register(Items.BEETROOT,				0.05f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(15, 8, 64, 1),	ImmutableSet.of("farmer"));
	...
	public final static BaseItemEconomy PUMPKIN =				register(Items.PUMPKIN,					0.2f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(16, 2, 64, 1),	ImmutableSet.of("farmer"));
	public final static BaseItemEconomy PUMPKIN_PIE =			register(Items.PUMPKIN_PIE,				0.4f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(4,  2, 64, 1),	ImmutableSet.of("farmer"));
	public final static BaseItemEconomy APPLE =					register(Items.APPLE,					0.2f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(16, 8, 64, 1),	ImmutableSet.of("farmer"));
	public final static BaseItemEconomy MELON =					register(Items.MELON,					0.2f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(32, 8, 64, 1),	ImmutableSet.of("farmer"));
	public final static BaseItemEconomy COOKIE =				register(Items.COOKIE,					0.16f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(32, 8, 64, 1),	ImmutableSet.of("farmer"));
	...
	public final static BaseItemEconomy GOLDEN_CARROT =			register(Items.GOLDEN_CARROT,			1f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(32, 8, 64, 1),	ImmutableSet.of("farmer"));
	public final static BaseItemEconomy GLISTERING_MELON_SLICE= register(Items.GLISTERING_MELON_SLICE,	1.3f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(32, 8, 64, 1),	ImmutableSet.of("farmer"));
	
	public final static BaseItemEconomy STRING = 				register(Items.STRING,					0.05f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(32, 8, 64, 1),	ImmutableSet.of("fischerman", "fletcher"));
	public final static BaseItemEconomy COD = 					register(Items.COD,						0.1f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(32, 8, 64, 1),	ImmutableSet.of("fischerman"));
	public final static BaseItemEconomy SALMON = 				register(Items.SALMON,					0.1f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(32, 8, 64, 1),	ImmutableSet.of("fischerman"));
	...
	public final static BaseItemEconomy TROPICAL_FISH = 		register(Items.TROPICAL_FISH,			0.4f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(32, 8, 64, 1),	ImmutableSet.of("fischerman"));
	public final static BaseItemEconomy PUFFERFISH = 			register(Items.PUFFERFISH,				0.25f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(32, 8, 64, 1),	ImmutableSet.of("fischerman"));
	...
	public final static BaseItemEconomy COOKED_COD = 			ItemCompundEconomy.register(Items.COOKED_COD,    ImmutableSet.of(ImmutablePair.of(COD, 1f), ImmutablePair.of(COAL, 0.2f)), new ConstrainedGaussianIntRandom(32, 8, 64, 1), 	ImmutableSet.of("fischerman"));
	public final static BaseItemEconomy COOKED_SALMON = 		ItemCompundEconomy.register(Items.COOKED_SALMON, ImmutableSet.of(ImmutablePair.of(COD, 1f), ImmutablePair.of(COAL, 0.2f)), new ConstrainedGaussianIntRandom(32, 8, 64, 1), 	ImmutableSet.of("fischerman"));

	public final static BaseItemEconomy STICK = 				register(Items.STICK,					0.03f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(32, 8, 64, 1),	ImmutableSet.of("fletcher"));
	public final static BaseItemEconomy FLINT = 				register(Items.FLINT,					0.03f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(32, 8, 64, 1),	ImmutableSet.of("fletcher", "leatherworker", "toolsmith", "weaponsmith"));
	public final static BaseItemEconomy FEATHER = 				register(Items.FEATHER,					0.1f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(32, 8, 64, 1),	ImmutableSet.of("fletcher"));
	...
	public final static BaseItemEconomy TRIPWIRE_HOOK =			register(Items.TRIPWIRE_HOOK,			1.3f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(32, 8, 64, 1),	ImmutableSet.of("fletcher"));
	public final static BaseItemEconomy ARROW = 				register(Items.ARROW,					1.3f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(32, 8, 64, 1),	ImmutableSet.of("fletcher"));
	public final static BaseItemEconomy TIPPED_ARROW = 			register(Items.TIPPED_ARROW,			2f, 		0.01f,		0.001f, new ConstrainedGaussianIntRandom(32, 8, 64, 1),	ImmutableSet.of("fletcher")).modify(ARROW_POTION_EFFECT_MODIFIER);
	
	public final static BaseItemEconomy LEATHER =				register(Items.LEATHER, 				0.1f,	 	0.01f, 		0.001f, new ConstrainedGaussianIntRandom(32, 8, 64, 1),	ImmutableSet.of("leatherworker"));
	public final static BaseItemEconomy RABBIT_HIDE =			register(Items.RABBIT_HIDE,				0.111f, 	0.01f, 		0.001f, new ConstrainedGaussianIntRandom(32, 8, 64, 1),	ImmutableSet.of("leatherworker"));
	...
	public final static BaseItemEconomy BOOKSHELF =				register(Items.BOOKSHELF,				9f, 		0.01f, 		0.001f, new ConstrainedGaussianIntRandom(16, 4, 64, 1),	ImmutableSet.of("librarian"));
	...
	public final static BaseItemEconomy LANTERN =				register(Items.LANTERN,					1f, 		0.01f, 		0.001f, new ConstrainedGaussianIntRandom(16, 4, 64, 1),	ImmutableSet.of("librarian"));
	public final static BaseItemEconomy GLASS =					register(Items.GLASS,					0.25f, 		0.01f, 		0.001f, new ConstrainedGaussianIntRandom(16, 4, 64, 1),	ImmutableSet.of("librarian"));
	...
	public final static BaseItemEconomy CLOCK =					register(Items.CLOCK,					5f, 		0.01f, 		0.001f, new ConstrainedGaussianIntRandom(16, 4, 64, 1),	ImmutableSet.of("librarian"));
	...
	public final static BaseItemEconomy CLAY =					register(Items.CLAY,					0.1f, 		0.01f, 		0.001f, new ConstrainedGaussianIntRandom(48, 4, 64, 1),	ImmutableSet.of("mason"));
	public final static BaseItemEconomy BRICK =					register(Items.BRICK,					0.1f, 		0.01f, 		0.001f, new ConstrainedGaussianIntRandom(48, 4, 64, 1),	ImmutableSet.of("mason"));
	public final static BaseItemEconomy STONE =					register(Items.STONE,					0.05f, 		0.01f, 		0.001f, new ConstrainedGaussianIntRandom(48, 4, 64, 1),	ImmutableSet.of("mason"));
	public final static BaseItemEconomy DIORITE =				register(Items.DIORITE,					0.05f, 		0.01f, 		0.001f, new ConstrainedGaussianIntRandom(48, 4, 64, 1),	ImmutableSet.of("mason"));
	public final static BaseItemEconomy GRANITE =				register(Items.GRANITE,					0.05f, 		0.01f, 		0.001f, new ConstrainedGaussianIntRandom(48, 4, 64, 1),	ImmutableSet.of("mason"));
	public final static BaseItemEconomy ANDESITE =				register(Items.ANDESITE,				0.05f, 		0.01f, 		0.001f, new ConstrainedGaussianIntRandom(48, 4, 64, 1),	ImmutableSet.of("mason"));
	public final static BaseItemEconomy POLISHED_ANDESITE =		register(Items.POLISHED_ANDESITE,		0.05f, 		0.01f, 		0.001f, new ConstrainedGaussianIntRandom(48, 4, 64, 1),	ImmutableSet.of("mason"));
	public final static BaseItemEconomy POLISHED_DIORITE =		register(Items.POLISHED_DIORITE,		0.05f, 		0.01f, 		0.001f, new ConstrainedGaussianIntRandom(48, 4, 64, 1),	ImmutableSet.of("mason"));
	public final static BaseItemEconomy POLISHED_GRANITE =		register(Items.POLISHED_GRANITE,		0.05f, 		0.01f, 		0.001f, new ConstrainedGaussianIntRandom(48, 4, 64, 1),	ImmutableSet.of("mason"));
	public final static BaseItemEconomy DRIPSTONE_BLOCK =		register(Items.DRIPSTONE_BLOCK,			0.05f, 		0.01f, 		0.001f, new ConstrainedGaussianIntRandom(48, 4, 64, 1),	ImmutableSet.of("mason"));
	public final static BaseItemEconomy CHISELED_STONE_BRICKS =	register(Items.CHISELED_STONE_BRICKS,	0.25f, 		0.01f, 		0.001f, new ConstrainedGaussianIntRandom(48, 4, 64, 1),	ImmutableSet.of("mason"));
	public final static BaseItemEconomy QUARTZ =				register(Items.QUARTZ,					12f, 		0.01f, 		0.001f, new ConstrainedGaussianIntRandom(16, 4, 64, 1),	ImmutableSet.of("mason")).modify(BUY_ONLY_MODIFIER);
	public final static BaseItemEconomy TERRACOTTA =			register(Items.TERRACOTTA,				1f, 		0.01f, 		0.001f, new ConstrainedGaussianIntRandom(32, 4, 64, 1),	ImmutableSet.of("mason")).modify(TERRACOTTA_COLOR_MODIFIER);
	public final static BaseItemEconomy QUARTZ_PILLAR =			register(Items.QUARTZ_PILLAR,			1f, 		0.01f, 		0.001f, new ConstrainedGaussianIntRandom(16, 4, 64, 1),	ImmutableSet.of("mason")).modify(SELL_ONLY_MODIFIER);
	
	public final static BaseItemEconomy WOOL =					register(Items.BLACK_WOOL,				1f, 		0.01f, 		0.001f, new ConstrainedGaussianIntRandom(32, 4, 64, 1),	ImmutableSet.of("shepherd")).modify(WOOL_COLOR_MODIFIER);
	public final static BaseItemEconomy CARPET =				register(Items.BLACK_CARPET,			2f, 		1f, 		0.001f, new ConstrainedGaussianIntRandom(32, 4, 64, 1),	ImmutableSet.of("shepherd")).modify(CARPET_COLOR_MODIFIER);
	...
	public final static BaseItemEconomy IRON_AXE =				register(Items.IRON_AXE,				20f, 		1f, 		0.001f, new ConstantValue<Integer>(1),					ImmutableSet.of("toolsmith", "weaponsmith")).modify(SELL_ONLY_MODIFIER).modify(AXE_ENCHANTMENT_MODIFIER);
	...
	public final static BaseItemEconomy IRON_SWORD =			register(Items.IRON_SWORD,				20f, 		1f, 		0.001f, new ConstantValue<Integer>(1),					ImmutableSet.of("weaponsmith")).modify(SELL_ONLY_MODIFIER).modify(SWORD_ENCHANTMENT_MODIFIER);
	public final static BaseItemEconomy DIAMOND_AXE =			register(Items.DIAMOND_AXE,				40f, 		1f, 		0.001f, new ConstantValue<Integer>(1),					ImmutableSet.of("toolsmith", "weaponsmith")).modify(SELL_ONLY_MODIFIER).modify(AXE_ENCHANTMENT_MODIFIER);
	...
	public final static BaseItemEconomy DIAMOND_SWORD =			register(Items.DIAMOND_SWORD,			40f, 		1f, 		0.001f, new ConstantValue<Integer>(1),					ImmutableSet.of("weaponsmith")).modify(SELL_ONLY_MODIFIER).modify(SWORD_ENCHANTMENT_MODIFIER);
