...
public class MerchantRenderer extends GeoEntityRenderer<AmaziaMerchant> {
    public MerchantRenderer(EntityRendererFactory.Context ctx) {
        super(ctx, new MerchantModel());
        this.shadowRadius = 0.4f;
    }

    @Override
    public Identifier getTextureResource(AmaziaMerchant instance) {
        return new Identifier(Amazia.MOD_ID, "textures/entity/farmer_texture.png");
    }

    @Override
    public RenderLayer getRenderType(AmaziaMerchant animatable, float partialTicks, MatrixStack stack,
