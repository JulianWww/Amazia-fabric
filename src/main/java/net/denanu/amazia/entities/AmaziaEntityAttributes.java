...
public class AmaziaEntityAttributes {
	public static EntityAttribute MAX_HUNGER = AmaziaEntityAttributes.register("villager.max_hunger", new ClampedEntityAttribute("amazia:attribute.villager.max_hunger", 20f, 1f, 1024f));
