...
public class RancherRenderer extends GeoEntityRenderer<RancherEntity> {
	public RancherRenderer(final EntityRendererFactory.Context ctx) {
		super(ctx, new RancherModel());
		this.shadowRadius = 0.4f;
	}

	@Override
	public Identifier getTextureResource(final RancherEntity instance) {
		return new Identifier(Amazia.MOD_ID, "textures/entity/farmer_texture.png");
	}

	@Override
	public RenderLayer getRenderType(final RancherEntity animatable, final float partialTicks, final MatrixStack stack,
