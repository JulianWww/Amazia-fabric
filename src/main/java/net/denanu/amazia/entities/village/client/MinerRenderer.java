...
public class MinerRenderer extends GeoEntityRenderer<MinerEntity> {
	public MinerRenderer(final EntityRendererFactory.Context ctx) {
		super(ctx, new MinerModel());
		this.shadowRadius = 0.4f;
	}

	@Override
	public Identifier getTextureResource(final MinerEntity instance) {
		return new Identifier(Amazia.MOD_ID, "textures/entity/farmer_texture.png");
	}

	@Override
	public RenderLayer getRenderType(final MinerEntity animatable, final float partialTicks, final MatrixStack stack,
