...
public abstract class AmaziaGoToBlockGoal extends AmaziaVillageGoal {
	...
	public AmaziaGoToBlockGoal(AmaziaVillagerEntity e, int priority) {
		super(e, priority);
	...
	public boolean shouldContinue() {
		return super.canStart() && path != null && targetPos != null && !this.reached && path.getLength() > 1;
	}
	...
	protected void recalcPath() {
		path = this.entity.getVillagePathFinder().findPath(this.entity.world, this.targetPos.up());
