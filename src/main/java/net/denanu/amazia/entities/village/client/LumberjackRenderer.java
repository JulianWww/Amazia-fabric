...
public class LumberjackRenderer extends GeoEntityRenderer<LumberjackEntity> {
	public LumberjackRenderer(final EntityRendererFactory.Context ctx) {
		super(ctx, new LumberjackModel());
		this.shadowRadius = 0.4f;
	}

	@Override
	public Identifier getTextureResource(final LumberjackEntity instance) {
		return new Identifier(Amazia.MOD_ID, "textures/entity/farmer_texture.png");
	}

	@Override
	public RenderLayer getRenderType(final LumberjackEntity animatable, final float partialTicks, final MatrixStack stack,
